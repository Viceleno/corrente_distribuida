...
# def descobriNumeroGerado(controle):
...
#     thread1 = threading.Thread(target=descobriNumeroGerado, name="Thread 1", args=(True,))
#     thread2 = threading.Thread(target=descobriNumeroGerado, name="Thread 2", args=(False,))
